...
void testReadFileForBadFile() {
  cout << "Start testing method readFile() for bad input" << endl;
  Autocomplete ac;
  ac.readFile("badFile.txt");
  cout << "End testing method readFile() for bad input" << endl;
}
